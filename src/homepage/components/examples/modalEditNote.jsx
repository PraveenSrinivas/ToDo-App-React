...
class ModalNoteComponent extends Component {
    ...
    addOrEditNote = (mode, index) => {
        mode === 'add'
            ? this.setState({
                  addOrEditNoteModalData: GetRawObject(
                      this.createNoteDefaultData
                  ),
              })
            : mode === 'edit'
            ? this.setState({
    ...
    confirmAddOrEditNote = addOrEditNoteModalData => {
        ...
        addOrEditNoteModalData.mode === 'add'
            ...
            ? (notes[addOrEditNoteModalData.index] =
                  addOrEditNoteModalData.noteForm)
            : alert('Mode mismatch')
        this.setState({ notes })
    }
